...
CREATE TABLE "EVENT" (
    "EVENT_NO" NUMBER,
    "EVENT_GUBUN" CHAR(1) DEFAULT '0',
    "EVENT_TITLE" VARCHAR2(200),
    "EVENT_CONTENT" VARCHAR2(4000),
    "EVENT_DATE" DATE,
    "EVENT_THUMBNAIL" VARCHAR2(1000),
    CONSTRAINT "EVENT_PK" PRIMARY KEY ("EVENT_NO")
);

-- 컬럼 설명
COMMENT ON COLUMN "EVENT"."EVENT_NO" IS '이벤트번호';
COMMENT ON COLUMN "EVENT"."EVENT_GUBUN" IS '공개여부(0=비공개, 1=공개)';
COMMENT ON COLUMN "EVENT"."EVENT_TITLE" IS '이벤트제목';
COMMENT ON COLUMN "EVENT"."EVENT_CONTENT" IS '이벤트내용';
COMMENT ON COLUMN "EVENT"."EVENT_DATE" IS '이벤트날짜';
COMMENT ON COLUMN "EVENT"."EVENT_THUMBNAIL" IS '썸네일이미지';

-- 시퀀스 생성 (이벤트 번호 자동 증가용)
...
-- 샘플 데이터 삽입 (선택사항)
INSERT INTO EVENT (EVENT_NO, EVENT_GUBUN, EVENT_TITLE, EVENT_CONTENT, EVENT_DATE, EVENT_THUMBNAIL)
VALUES (1, '1', '신규 회원 가입 이벤트', '신규 회원 가입 시 5000원 할인 쿠폰을 드립니다!', TO_DATE('2024-01-01', 'YYYY-MM-DD'), 'event_sample1.jpg');

INSERT INTO EVENT (EVENT_NO, EVENT_GUBUN, EVENT_TITLE, EVENT_CONTENT, EVENT_DATE, EVENT_THUMBNAIL)
VALUES (2, '1', '봄맞이 특가 세일', '봄 신상품 최대 50% 할인!', TO_DATE('2024-03-01', 'YYYY-MM-DD'), 'event_sample2.jpg');

INSERT INTO EVENT (EVENT_NO, EVENT_GUBUN, EVENT_TITLE, EVENT_CONTENT, EVENT_DATE, EVENT_THUMBNAIL)
VALUES (3, '0', '여름 이벤트 준비중', '곧 공개됩니다.', TO_DATE('2024-06-01', 'YYYY-MM-DD'), 'event_sample3.jpg');
