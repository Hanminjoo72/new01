...
<body onload="fn_allPrice()"><!-- 주문페이지 로딩시 주문금액,포인트 등 계산 -->
    <div class="container">
      ...
      <form id="commonForm" name="commonForm"></form>
      	<form name="basket" method="post" action="<c:url value='/order/basketAllOrderWrite.do'/>">
					...
					<c:forEach items="${list }" var="row" varStatus="status">
						...
						<tr>
							<td style="text-align:center">
                  			...
                  			<td>
                  				<img src='${pageContext.request.contextPath}/file/${row.GOODS_THUMBNAIL}' width="70px" height="70px">
                  			</td>
							<td>
				  				<a href="<c:url value='/shop/goodsDetail.do'/>?IDX=${row.GOODS_NO }">${row.GOODS_NAME }</a> <br>
