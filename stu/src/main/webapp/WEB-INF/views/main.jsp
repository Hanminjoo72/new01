...
<div align="center">
<ul class="bxslider">
<%--      <li><a href="#"><img src="<c:url value='/img/main2.jpg'/>" ></a></li>--%>
      <li><a href="#"><img src="<c:url value='/img/spot1.jpg'/>" alt=""></a></li>
      <li><a href="#"><img src="<c:url value='/img/spot2.jpg'/>" alt=""></a></li>
      <li><a href="#"><img src="<c:url value='/img/spot3.jpg'/>" alt=""></a></li>
</ul>
</div>
...
// context path for building absolute URLs
...
function fn_selectNewItemListCallback(data) {
	...
	if (total == 0) {
		...
		$.each(data.NewList, function(key, value) {
							var imgpath = "<img src='"+ contextPath +"/file/"+value.GOODS_THUMBNAIL+"' width='400' height='400'>"
							...
							str +=    "<div class='card'>"
								...
								+	  "<div class='imgswap'>"
								+ 	  "<img src='"+ contextPath +"/file/"+img0+"' width='400' height='400'>" 
								+ 	  "<img src='"+ contextPath +"/file/"+img1+"' width='400' height='400'>"
								+     " </div> "
