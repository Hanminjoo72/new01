...
.card-header {
   ...
   background-image: url('<c:url value="/resources/images/no_image.png"/>');
...
.icon-view_count {
    width: 25px;
    height: 17px;
   background: url('<c:url value="/images/eye.jpg"/>') no-repeat;
}
.icon-comments_count {
   margin-left: 5px;
   width: 25px;
    height: 17px;
   background: url('<c:url value="/images/comment.jpg"/>') no-repeat;   
}
.reg_date {
	margin-left: 15px;
   float: ;
...
<div align="right" style="margin-right:410px">
	<table>
		<tr>
			...
			<td class="font1"><a href="<c:url value='/shop/goodsList/${category}/NewItem.do'/>"> 신상품순 </a></td> <td> | </td>
			<td class="font1"><a href="<c:url value='/shop/goodsList/${category}/favorite.do'/>"> 인기상품순 </a></td> <td> | </td>
			<td class="font1"><a href="<c:url value='/shop/goodsList/${category}/low.do'/>"> 낮은가격순 </a></td> <td> | </td>
			<td class="font1"><a href="<c:url value='/shop/goodsList/${category}/high.do'/>"> 높은가격순 </a></td>
		</tr>
	</table>
</div>
...
// context path for building absolute URLs in JS
...
function fn_selectGoodsListCallback(data) {
	...
	if (total == 0) {
		...
		$.each(data.list, function(key, value) {
							var imgpath = "<img src='"+ ctx +"/file/"+value.GOODS_THUMBNAIL+"' width='400' height='400'>"
							...
							str += "<div class='card'>"
								...
								+		"<div class='imgswap'>"
								+ 		"<img src='"+ ctx +"/file/"+img0+"' width='400' height='400'>" 
								+ 		"<img src='"+ ctx +"/file/"+img1+"' width='400' height='400'>"
								+     " </div> "
