...
<body>
<div class="container">
	<div style="position: fixed; left: 0; top: 0; width: 220px; height: 100vh; overflow-y: auto;">
		<%@include file="/WEB-INF/tiles/mySide.jsp" %>
	</div>
	<div id="memberModify" style="margin-left: 240px;">
		<form id="signUp" method="post" action="<c:url value='/my/memberModifyAction.do'/>">
