...
<body onload="fn_allPrice()">
    <div class="container">
      ...
      <form name="orderWrite" id="orderWrite" method="post" action="<c:url value='/order/orderPay.do'/>">
      	<%-- <!-- goods정보 -->
            ...
            <colgroup>
              ...
              <tbody>
					...
					<c:forEach items="${list }" var="row" varStatus="status">
                        ...
                        <input type="hidden" name="basket_goods_amount" value="${row.BASKET_GOODS_AMOUNT }">
                        <input type="hidden" name="goods_sell_price" value="${row.GOODS_SELL_PRICE }">
                        <input type="hidden" name="ORDER_DETAIL_PRICE" value="0">
                        <input type="hidden" name="COUPON_DISCOUNT" value="0">
                        <input type="hidden" name="ORDER_DISCOUNT_APPLY" value="0">
					</c:forEach>
		              </tbody>
		            </table>
		          </div>
		          ...
		          <div class="table-responsive">
		            ...
		            <div style="text-align:center">
		            	<input type="checkbox" name="orderChk" id="orderChk">
		          		...
		          		<br><br>
		                <input type="button" name="all_order" value="장바구니" onClick="location.href='<c:url value='/basket/basketList.do'/>'">
