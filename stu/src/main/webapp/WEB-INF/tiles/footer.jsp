	...
	<div class="footer-top">
		<div class="comm-w clear dpi_wrap">
			...
			<div class="group board">
				...
				<div class="con">
					<ul>
						<!--<li><a href="<c:url value='/cscenter/consultReg.asp'/>"><span>1:1문의</span></a></li>-->
						<li><a href="<c:url value='/notice/openNoticeList.do'/>"><span>공지사항</span></a></li>
						<li><a href="<c:url value='/qna/openQnaList.do'/>"><span>문의게시판</span></a></li>
						<li><a href="<c:url value='/faq/openFaqList.do'/>"><span>FAQ</span></a></li>
