...
<div class="navbar-default sidebar" role="navigation" style="width: 230px;">
	<div style="width: 180px;height: 130px;background-color: #a4a4b0;text-align: center;">
		<br />
		<h2><img src="<c:url value='/img/ad.png'/>" style="width : 100%"></h2>
		<%--		<h2>관리자</h2>--%>
		<%--		<p>Admin</p>--%>
	</div>
	...
	<div class="sidebar-nav navbar-collapse" style="width:180px;">
		<ul class="nav" id="side-menu">
			...
			<li><a href="<c:url value='/checkPing.do'/>" style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
				<b class="fa fa-dashboard fa-fw">서버관리</b> ⚙️
			</a></li>

			<li><a href="<c:url value='/main.do'/>" style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
				<b class="fa fa-dashboard fa-fw">쇼핑몰로 이동</b>
			</a></li>

			<li><a href="<c:url value='/order_admin_a.do'/>"
				   style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
				<b class="fa fa-dashboard fa-fw">주문배송관리</b>
			</a></li>

			<li><a href="<c:url value='/as_admin.do'/>" style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
			...
			<li><a href="#" style="background: #e7e7e7;">
				...
				<ul class="nav nav-second-level">
					<li><a href="<c:url value='/shop/openGoodsList.do'/>">- 상품목록/수정</a></li>
					<li><a href="<c:url value='/shop/openGoodsWrite.do'/>">- 상품등록</a></li>
					<!-- <li><a href="">- 할인 적용</a></li> -->
				</ul></li>


			<li><a href="<c:url value='/member_admin.do'/>"
				   style="background: #e7e7e7; border-bottom: 1px solid #F8F8F8;">
			...
			<li class="active"><a href="#" style="background: #e7e7e7;">
				...
				<ul class="nav nav-second-level">
					<li><a href="<c:url value='/notice/openNoticeList.do'/>">- 공지사항</a></li>
					<li><a href="<c:url value='/faq/openFaqList.do'/>">- FAQ</a></li>
					<li><a href="<c:url value='/qna/openQnaList.do'/>">- 상품Q&A</a></li>
				</ul></li>
			...
			<li class="active">
				...
				<ul class="nav nav-second-level">
					<li><a href="<c:url value='/adminCouponList.do'/>">- 쿠폰목록/수정</a></li>
					<li><a href="<c:url value='/adminCouponWriteForm.do'/>">- 쿠폰등록</a></li>
				</ul>
			</li>
			<!-- e 쿠폰 추가 2020.06.25 -->
			...
			<li class="active">
				...
				<ul class="nav nav-second-level">
					<li><a href="<c:url value='/adminEventList.do'/>">- 이벤트목록/수정</a></li>
					<li><a href="<c:url value='/adminEventWriteForm.do'/>">- 이벤트등록</a></li>
				</ul>
			</li>
			<!-- e 이벤트 추가 2020.06.30 -->
